...
class Report(Base):
    ...
    source_leadback_json = Column(db.JSON, default=None)
    source_avito_json = Column(db.JSON, default=None)
    ...
    def init_on_load(self):
        ...
        self.source_leadback = SourceLeadBack.model_validate(self.source_leadback_json)
        self.source_avito = SourceAvito.model_validate(self.source_avito_json)
        try:
...
LeadBack (SEO/контекст)
{self.source_leadback.seo} / {self.source_leadback.context}
        
Avito (Звонки/сообщения)
{self.source_avito.calls} / {self.source_avito.chats}
...
0-10 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=0&max=10&is_success=1&id={self.id}'>{len(s_recalls_0_10)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=0&max=10&is_success=0&id={self.id}'>{len(f_recalls_0_10)}</a>
10-20 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=10&max=10&is_success=1&id={self.id}'>{len(s_recalls_10_20)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=10&max=20&is_success=0&id={self.id}'>{len(f_recalls_10_20)}</a>
20-30 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=20&max=10&is_success=1&id={self.id}'>{len(s_recalls_20_30)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=20&max=30&is_success=0&id={self.id}'>{len(f_recalls_20_30)}</a>
30-40 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=30&max=10&is_success=1&id={self.id}'>{len(s_recalls_30_40)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=30&max=40&is_success=0&id={self.id}'>{len(f_recalls_30_40)}</a>
40-50 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=40&max=10&is_success=1&id={self.id}'>{len(s_recalls_40_50)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=40&max=50&is_success=0&id={self.id}'>{len(f_recalls_40_50)}</a>
50-60 (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=50&max=10&is_success=1&id={self.id}'>{len(s_recalls_50_60)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=50&max=60&is_success=0&id={self.id}'>{len(f_recalls_50_60)}</a>
60+ (П/О): <a href='https://se-bot.ru/dashboard/recalls?min=60&max=10000&is_success=1&id={self.id}'>{len(s_recalls_60)}</a> / <a href='https://se-bot.ru/dashboard/recalls?min=60&max=10000&is_success=0&id={self.id}'>{len(f_recalls_60)}</a>
"""
